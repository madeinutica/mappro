...
const ProjectPopup = ({ project, modalConfig }) => {
  // Default modal config if not provided
  ...
  return (
    <div className="max-w-xs bg-neutral-cream p-2">
      ...
      {/* Reviews */}
      {config.showReviews && project.reviews && project.reviews.length > 0 && (
        <div className="mb-2">
      ...
      {/* Categories */}
      {config.showCategories && project.categoryInfo && project.categoryInfo.length > 0 && (
      ...
      {/* Sub-categories */}
      {config.showSubCategories && project.subCategoryInfo && project.subCategoryInfo.length > 0 && (
      ...
      {/* Product Details */}
      {config.showProductDetails && project.description && (
        <div className="mb-2">
